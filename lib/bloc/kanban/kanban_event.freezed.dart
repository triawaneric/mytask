...
mixin _$KanbanEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String title, String due_date, String color,
            bool status, int column)
        addTask,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String title, String due_date, String color, bool status,
            int column)?
        addTask,
  }) =>
      throw _privateConstructorUsedError;
...
class __$$UpdateTaskCopyWithImpl<$Res>
    extends _$KanbanEventCopyWithImpl<$Res, _$UpdateTask>
...
class _$UpdateTask implements UpdateTask {
  const _$UpdateTask(this.column, this.task);
  ...
  @override
  String toString() {
    return 'KanbanEvent.updateTask(column: $column, task: $task)';
  }
...
abstract class UpdateTask implements KanbanEvent {
  const factory UpdateTask(final int column, final KTask task) = _$UpdateTask;
...
abstract class _$$AddTaskCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String title, String due_date, String color, bool status, int column});
}
...
class _$AddTask implements AddTask {
  const _$AddTask(
      this.title, this.due_date, this.color, this.status, this.column);
  ...
  @override
  String toString() {
    return 'KanbanEvent.addTask(title: $title, due_date: $due_date, color: $color, status: $status, column: $column)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, title, due_date, color, status, column);
  ...
  TResult when<TResult extends Object?>({
    ...
    return addTask(title, due_date, color, status, column);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return addTask?.call(title, due_date, color, status, column);
  }
...
abstract class AddTask implements KanbanEvent {
  const factory AddTask(final String title, final String due_date,
      final String color, final bool status, final int column) = _$AddTask;
